...
export default [
    ...
    new PlayerSetting(PlayerSetting.CATEGORY.ANNOUNCEMENT, PlayerSetting.ANNOUNCEMENT.GANGS, PlayerSetting.SUBCOMMAND.GENERAL, 'gangs', PlayerSetting.TYPE_BOOLEAN, true, 'These are ALL gang announcements. Individual settings will not be considered if turned off.'),
    new PlayerSetting(PlayerSetting.CATEGORY.ANNOUNCEMENT, PlayerSetting.ANNOUNCEMENT.GANGS, PlayerSetting.SUBCOMMAND.GANGS_CHANGED_SKIN, 'gangs skin changed', PlayerSetting.TYPE_BOOLEAN, true, 'This is the gang skin changed announcement.'),    
