...
export class RelativeTimeView extends TimeView {
    constructor(x, y) {
    ...
    setTime(player, time) {
        ...
        let needsRefresh = displaying && ((timeColor != this.color) ||
        ...
        if (this.markOffset_ != markOffset) {
            ...
            this.positiveMark_.position = [
                this.position_[0] + markOffset + this.positiveMarkOffset_,
                this.positiveMark_.position[1]
            ];

            this.negativeMark_.position = [
                this.position_[0] + markOffset + this.negativeMarkOffset_,
