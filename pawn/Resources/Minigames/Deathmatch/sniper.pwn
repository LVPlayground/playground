...
SetPlayerUpForSniper(playerId) {
    ...
    new Float: randomSniperSpawns[37][spawnInfo] = {
    ...
    new randomPosition = random(2500) % sizeof(randomSniperSpawns);
    SetPlayerPos(playerId, randomSniperSpawns[randomPosition][posX], randomSniperSpawns[randomPosition][posY],
        randomSniperSpawns[randomPosition][posZ]);
    SetPlayerFacingAngle(playerId, randomSniperSpawns[randomPosition][angle]);
